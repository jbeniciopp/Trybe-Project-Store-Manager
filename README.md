...
<details>
  <summary><strong>👨‍💻 O que foi desenvolvido</strong></summary>
    ...
    Neste projeto eu desenvolvi uma API utilizando a arquitetura MSC (model-service-controller)!

    A API a que foi construída é um sistema de gerenciamento de vendas no formato dropshipping em que será possível criar, visualizar, deletar e atualizar produtos e vendas. Foi utilizado o banco de dados MySQL para a gestão de dados. Além disso, a API é RESTful.
...
## Requisitos do que foi desenvolvido
